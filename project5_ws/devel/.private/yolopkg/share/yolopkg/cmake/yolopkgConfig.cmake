...
if("TRUE" STREQUAL "TRUE")
  set(yolopkg_SOURCE_PREFIX /home/robocon/RC/project5_ws/src/yolopkg)
  set(yolopkg_DEVEL_PREFIX /home/robocon/RC/project5_ws/devel/.private/yolopkg)
  set(yolopkg_INSTALL_PREFIX "")
  set(yolopkg_PREFIX ${yolopkg_DEVEL_PREFIX})
else()
  set(yolopkg_SOURCE_PREFIX "")
  set(yolopkg_DEVEL_PREFIX "")
  set(yolopkg_INSTALL_PREFIX /home/robocon/RC/project5_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'yolopkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robocon/RC/project5_ws/src/yolopkg/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robocon/RC/project5_ws/devel/.private/yolopkg/lib;/home/robocon/RC/project5_ws/devel/lib;/home/robocon/ladar/devel/lib;/opt/ros/noetic/lib)
